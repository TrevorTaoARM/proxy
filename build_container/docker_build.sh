...
docker buildx build --platform linux/amd64,linux/arm64  -f ${SCRIPTS_DIR}/../Dockerfile.builder.multi_arch . -t ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/cilium-builder:${IMAGE_TAG}
